...
-rw-r--r--. 1 root root  102 Dec  9 19:12 cm.repo
-rw-r--r--. 1 root root 1209 Dec  9 18:44 mysql-community.repo
...
```
[root@clouderaseb01 ~]# /usr/share/cmf/schema/scm_prepare_database.sh mysql scm scm scm -h clouderaseb00.gitcluster.com
```